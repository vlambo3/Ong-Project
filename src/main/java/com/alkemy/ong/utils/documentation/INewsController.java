...
public interface INewsController {
    ...
    ResponseEntity<NewsResponseDto> addNewNews(@Parameter(description = "Request DTO for add a new News.") NewsRequestDto dto);
    ...
    ResponseEntity<NewsResponseDto> getNewsById(@Parameter(description = "ID to find news.")Long id);
    ...
    ResponseEntity<PageDto<NewsResponseDto>> getPage(@Parameter(description = "Number of page.") int page);
    ...
    ResponseEntity<List<CommentBasicResponseDto>> getCommentsByNewsId(@Parameter(description = "News comments.") Long id);
    ...
    ResponseEntity<NewsResponseDto> updateNews(@Parameter(description = "ID to find news.") Long id,
                                           @Parameter(description = "Request DTO to update news data.") NewsRequestDto news);
    ...
    ResponseEntity<Void> deleteNews(
            @Parameter(description = "ID to find news") Long id);
