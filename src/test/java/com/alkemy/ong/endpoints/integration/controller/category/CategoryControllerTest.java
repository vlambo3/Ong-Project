package com.alkemy.ong.endpoints.integration.controller.category;
...
public class CategoryControllerTest {
    ...
    void createCategoryAdmin201() throws Exception {
        when(service.create(categoryDto)).thenReturn(mapper.map(categoryDto, CategoryResponseDto.class));
